...
export const NativeAd: React.FC<{
  ...
  >
    ...
    <div className="flex min-w-0 flex-col gap-1.5">
      ...
      <span className="text-[13.5px] font-medium text-muted-foreground">برعاية: {sponsor}</span>
      <button className="mt-1 self-start rounded-full bg-brand px-4 py-2 text-[14.5px] font-bold text-white transition hover:bg-brand-deep">
        {cta} ←
      </button>
    </div>
  </div>
