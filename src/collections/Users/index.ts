...
export const Users: CollectionConfig = {
  ...
  /**
   * تخمين كلمات المرور هو الطريق الأقصر إلى لوحة تحكّم موقع إخباري:
   * الخادم يسجّل آلاف محاولات الدخول الفاشلة يومياً على منافذه. القفل بعد
   * خمس محاولات يجعل التخمين الآليّ بلا جدوى مهما طالت القائمة.
   *
   * والعمر ساعتان لا الافتراضي: جلسة مسروقة من جهاز مشترك في غرفة الأخبار
   * تنتهي صلاحيتها من نفسها بدل أن تبقى مفتوحة أياماً.
   */
  auth: {
    maxLoginAttempts: 5,
    lockTime: 10 * 60 * 1000,
