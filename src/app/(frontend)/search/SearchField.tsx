  ...
  return (
    ...
    >
      ...
      <input
        ...
        aria-label="البحث"
        className="min-w-0 flex-1 border-none bg-transparent text-[17.5px] text-foreground outline-none"
      />
      <button
        type="submit"
        className="shrink-0 cursor-pointer rounded-full bg-brand px-5 py-2.5 text-[16px] font-extrabold text-white transition hover:bg-brand-deep"
      >
        بحث
      </button>
    </form>
