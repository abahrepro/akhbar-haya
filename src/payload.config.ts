...
export default buildConfig({
  ...
  /**
   * مسار لوحة التحكّم ليس /admin.
   *
   * الماسحات الآلية تجرّب /admin و/wp-admin على كل نطاق تصادفه — والخادم
   * يسجّل آلاف المحاولات يومياً. تغيير المسار يصرفها كلّها، وهو إخفاء لا
   * حماية: من يصل إلى الباب يوقفه القفل بعد خمس محاولات لا اسم الباب.
   * ومجلّد المسار في التطبيق أُعيدت تسميته معه — الاثنان يجب أن يتطابقا.
   */
  routes: {
    admin: '/tahrir',
  },
